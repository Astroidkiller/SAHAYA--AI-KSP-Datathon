...
// ── Kannada Mock Responses ──

export const KANNADA_MOCK_RESPONSES: Record<string, ChatResponse> = {
  fact_highest_theft: {
    ...MOCK_RESPONSES.fact_highest_theft,
    answer:
      "ಬೆಂಗಳೂರು ನಗರ ಜಿಲ್ಲೆಯಲ್ಲಿ 2024-2025 ರ ಅವಧಿಯಲ್ಲಿ 12 ಕಳ್ಳತನ ಪ್ರಕರಣಗಳು ದಾಖಲಾಗಿದ್ದು ಅತ್ಯಂತ ಹೆಚ್ಚಿನ ಪ್ರಕರಣಗಳು ಇಲ್ಲಿ ಕಂಡುಬಂದಿವೆ. ಪ್ರಸ್ತುತ ಈ ಪ್ರವೃತ್ತಿ ಹೆಚ್ಚುತ್ತಿದ್ದು, ಮುಖ್ಯವಾಗಿ ಮೆಟ್ರೋ ಮತ್ತು ಬಸ್ ನಿಲ್ದಾಣಗಳ ಬಳಿ ದ್ವಿಚಕ್ರ ವಾಹನ ಕಳ್ಳತನ ಹಾಗೂ ಸರಗಳ್ಳತನ ಪ್ರಕರಣಗಳು ಸೇರಿವೆ. ⚠️ ಇದು ರಾಜ್ಯದ ಸರಾಸರಿಗಿಂತ 2.4 ಪಟ್ಟು ಹೆಚ್ಚಾಗಿದೆ.",
  },

  narrative_mo_pattern: {
    ...MOCK_RESPONSES.narrative_mo_pattern,
    answer:
      "ಪ್ರಕರಣದ ದಾಖಲೆಗಳ ಆಧಾರದ ಮೇಲೆ, ಎಂ.ಜಿ. ರಸ್ತೆ ಪ್ರದೇಶದಲ್ಲಿ ಸರಣಿ ಸರಗಳ್ಳತನ ಪ್ರಕರಣಗಳು ಕಂಡುಬಂದಿವೆ. ಆರೋಪಿಗಳು ದ್ವಿಚಕ್ರ ವಾಹನದಲ್ಲಿ ಬಂದು ಹಿಂಬದಿ ಸವಾರ ಸರ ಕಸಿದು ವೇಗವಾಗಿ ಪರಾರಿಯಾಗುವ ಶೈಲಿ (Modus Operandi) ಬಳಸಿದ್ದಾರೆ. ಸಂಜೆ 5:00 ರಿಂದ 7:00 ರ ನಡುವೆ ಮೆಟ್ರೋ ನಿಲ್ದಾಣದಿಂದ ಹೊರಬರುವ ಮಹಿಳೆಯರನ್ನು ಗುರಿಯಾಗಿಸಲಾಗಿದೆ. ಮೂರು ಎಫ್‌ಐಆರ್‌ಗಳು (FIR-2024-BLR-0042, FIR-2024-BLR-0058, FIR-2024-BLR-0071) ಇದೇ ಮಾದರಿಯನ್ನು ಹೊಂದಿವೆ.\n\nಮಾದರಿ (MO): ದ್ವಿಚಕ್ರ ವಾಹನ ಸರಗಳ್ಳತನ — ಹಿಂಬದಿ ಸವಾರನಿಂದ ಸರ ಕಸಿತ\n\nಸಾಕ್ಷ್ಯಗಳು: 1. ಕಬ್ಬನ್ ಪಾರ್ಕ್ ಪೊಲೀಸ್ ಠಾಣೆಯಲ್ಲಿ ಎಫ್‌ಐಆರ್ ದಾಖಲು. 2. 3 ಪ್ರತ್ಯಕ್ಷದರ್ಶಿಗಳ ಹೇಳಿಕೆ. 3. ಸಿಸಿಟಿವಿ ದೃಶ್ಯಾವಳಿ ಪರಿಶೀಲನೆ. 4. ವಾಹನ ಟ್ರ್ಯಾಕಿಂಗ್ ಪ್ರಗತಿಯಲ್ಲಿದೆ.",
  },

  network_crime_ring: {
    ...MOCK_RESPONSES.network_crime_ring,
    answer:
      "ವಿಶ್ಲೇಷಣೆಯು ಬೆಂಗಳೂರು ನಗರದಲ್ಲಿ ಸಕ್ರಿಯವಾಗಿರುವ 4 ಆರೋಪಿಗಳ ಅಪರಾಧ ಜಾಲವನ್ನು ಬಹಿರಂಗಪಡಿಸುತ್ತದೆ. ಈ ಗುಂಪು ಕಳ್ಳತನ ಮತ್ತು ಸರಗಳ್ಳತನಕ್ಕೆ ಸಂಬಂಧಿಸಿದ 6 ಎಫ್‌ಐಆರ್‌ಗಳಿಗೆ ಸಂಪರ್ಕ ಹೊಂದಿದೆ. ರವಿ ಕುಮಾರ್ (S001) ಕೇಂದ್ರ ಬಿಂದುವಾಗಿದ್ದು, ನಾಯಕತ್ವದ ಪಾತ್ರವನ್ನು ವಹಿಸಿದ್ದಾನೆ. ಅಪಾಯದ ಮಟ್ಟ: ತೀವ್ರ ಅಪಾಯಕಾರಿ (HIGH).",
  },

  profile_suspect: {
    ...MOCK_RESPONSES.profile_suspect,
    answer:
      "**ಆರೋಪಿ ವಿವರ: ರವಿ ಕುಮಾರ್** (S001)\n\n• **ಅಪಾಯದ ಮಟ್ಟ:** ತೀವ್ರ ಅಪಾಯಕಾರಿ (High)\n• **ವಯಸ್ಸು:** 32 | **ಲಿಂಗ:** ಪುರುಷ\n• **ಜಿಲ್ಲೆ:** ಬೆಂಗಳೂರು ನಗರ\n• **ಅಡ್ಡಹೆಸರು:** ಬ್ಲೇಡ್, ಡಾನ್\n• **ಸಂಪರ್ಕಿತ ಎಫ್‌ಐಆರ್‌ಗಳು:** 4 ಪ್ರಕರಣಗಳು\n• **ವರ್ಗಗಳು:** ಕಳ್ಳತನ, ದರೋಡೆ\n\n⚠️ **ಮಾದರಿ ಎಚ್ಚರಿಕೆ:** \"ದ್ವಿಚಕ್ರ ವಾಹನ ಸರಗಳ್ಳತನ\" (3 ಬಾರಿ ಪುನರಾವರ್ತನೆ)\n\n🔗 **ಅಪರಾಧ ಜಾಲ:** CLU-001 ಗುಂಪಿನ ಸದಸ್ಯ (4 ಆರೋಪಿಗಳು)",
  },

  summary_case: {
    ...MOCK_RESPONSES.summary_case,
    answer:
      '**ಪ್ರಕರಣದ ಸಾರಾಂಶ: FIR-2024-BLR-0042**\n"ಕಬ್ಬನ್ ಪಾರ್ಕ್ ಪೊಲೀಸ್ ಠಾಣೆಯಲ್ಲಿ ಕಳ್ಳತನ ಪ್ರಕರಣ"\n\n15 ಜುಲೈ 2024 ರಂದು, ಬೆಂಗಳೂರು ನಗರ ಜಿಲ್ಲೆಯ ಕಬ್ಬನ್ ಪಾರ್ಕ್ ಠಾಣೆಯಲ್ಲಿ ಕಳ್ಳತನ ಪ್ರಕರಣ ದಾಖಲಾಗಿದೆ. ಎಂ.ಜಿ. ರಸ್ತೆ ಬಳಿ ಚಿನ್ನದ ಸರ ಕಸಿತ. ತನಿಖಾ ತಂಡವು 2 ಶಂಕಿತರನ್ನು ಗುರುತಿಸಿದೆ: ರವಿ ಕುಮಾರ್, ಸುರೇಶ್ ರೆಡ್ಡಿ. ಮಾದರಿ: ದ್ವಿಚಕ್ರ ವಾಹನ ಸರಗಳ್ಳತನ. ಸ್ಥಿತಿ: ತನಿಖೆಯಲ್ಲಿದೆ.\n\n**ಇದೇ ರೀತಿಯ ಹಿಂದಿನ ಪ್ರಕರಣಗಳು:**\n1. **FIR-2024-BLR-0058** — ಕೊರಮಂಗಲ ಠಾಣೆ (82% ಹೋಲಿಕೆ, ಬೆಂಗಳೂರು ನಗರ) ⚠️ ಸಮಾನ ಮಾದರಿ (MO)\n2. **FIR-2024-BLR-0071** — ವೈಟ್‌ಫೀಲ್ಡ್ ಠಾಣೆ (68% ಹೋಲಿಕೆ, ಬೆಂಗಳೂರು ನಗರ)\n3. **FIR-2024-MYS-0015** — ದೇವರಾಜ ಠಾಣೆ (35% ಹೋಲಿಕೆ, ಮೈಸೂರು)',
  },
};
...
export function getInitialMessages(lang: string): ChatMessage[] {
  if (lang === "kn") {
    return [
      {
        id: "welcome-kn",
        role: "assistant",
        content:
          "ನಮಸ್ಕಾರ! 🙏 ನಾನು **ಸಹಾಯ AI**, ಕರ್ನಾಟಕ ರಾಜ್ಯ ಪೊಲೀಸ್ ಅಪರಾಧ ಬುದ್ಧಿವಂತಿಕೆ ಸಹಾಯಕ. ನಾನು ನಿಮಗೆ ಈ ಕೆಳಗಿನ ವಿಷಯಗಳಲ್ಲಿ ಸಹಾಯ ಮಾಡಬಲ್ಲೆ:\n\n• **ಅಪರಾಧ ಅಂಕಿ-ಅಂಶಗಳು** — ಹಾಟ್‌ಸ್ಪಾಟ್‌ಗಳು, ಜಿಲ್ಲಾ ಹೋಲಿಕೆ, ಪ್ರವೃತ್ತಿ ವಿಶ್ಲೇಷಣೆ, ತೀವ್ರ ಹೆಚ್ಚಳದ ಪತ್ತೆ\n• **ಪ್ರಕರಣದ ವಿವರಗಳು** — ಅಪರಾಧ ಮಾದರಿಗಳು (MO), ಪ್ರಕರಣದ ವಿವರಗಳು, ಸಾಕ್ಷ್ಯ ಸಾರಾಂಶ\n• **ಆರೋಪಿಗಳ ನೆಟ್‌ವರ್ಕ್** — ಅಪರಾಧ ಜಾಲಗಳು, ಅಪಾಯದ ಮಟ್ಟ, ಗುಂಪುಗಳ ನಕ್ಷೆ\n• **ಆರೋಪಿ ವಿವರಣೆ (Profiles)** — ಕ್ರಿಮಿನಲ್ ಹಿನ್ನೆಲೆ, ಅಪರಾಧ ಶೈಲಿ, ಅಪಾಯದ ಮೌಲ್ಯಮಾಪನ\n• **ಎಫ್‌ಐಆರ್ ಸಾರಾಂಶ** — ಹಿಂದಿನ ಸಮಾನ ಪ್ರಕರಣಗಳ ಸ್ವಯಂಚಾಲಿತ ವರದಿಗಳು\n\nನೀವು ಇಂಗ್ಲಿಷ್‌ನಲ್ಲಿ ಟೈಪ್ ಮಾಡಬಹುದು ಅಥವಾ 🎤 ಮೈಕ್ರೋಫೋನ್ ಬಳಸಿ ಕನ್ನಡ ಧ್ವನಿ ಇನ್‌ಪುಟ್ ನೀಡಬಹುದು. ಇಂದು ನಾನು ನಿಮಗೆ ಹೇಗೆ ಸಹಾಯ ಮಾಡಲಿ?",
        timestamp: new Date().toISOString(),
      },
    ];
  }
